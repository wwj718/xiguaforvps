...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.canteen'
        db.add_column('main_link', 'canteen',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.canteen'
        db.delete_column('main_link', 'canteen')
    ...
    models = {
        ...
        'main.link': {
            ...
            'canteen': ('django.db.models.fields.CharField', [], {'default': "'other'", 'max_length': '20'}),
