...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.solved'
        db.add_column('main_link', 'solved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.solved'
        db.delete_column('main_link', 'solved')
    ...
    models = {
        ...
        'main.link': {
            ...
            'canteen': ('django.db.models.fields.CharField', [], {'default': "'ec'", 'max_length': '20'}),
